<script lang="ts">
	...
	let { x = 0, y = 0, w = 6, h = 7 }: Props = $props();
</script>

<Widget id="map-widget" title="ແຜນທີ່ລາວ • Map" {x} {y} {w} {h} minW={3} minH={4}>
	<Map center={[102.495, 17.975]} zoom={6} language="lo" class="rounded-none">
